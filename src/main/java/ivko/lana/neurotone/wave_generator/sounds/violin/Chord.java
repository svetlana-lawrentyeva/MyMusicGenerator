...
public enum Chord
{
    ...
    F {@Override public Pair<Integer, Integer>[] getChangeFactors() {return (Pair<Integer, Integer>[]) new Pair[] {new Pair<>(4,3), new Pair<>(3,2), new Pair<>(5,3)};}},
    G {@Override public Pair<Integer, Integer>[] getChangeFactors() {return (Pair<Integer, Integer>[]) new Pair[] {new Pair<>(3,2), new Pair<>(5,4), new Pair<>(9,8)};}},
    Em {@Override public Pair<Integer, Integer>[] getChangeFactors() {return (Pair<Integer, Integer>[]) new Pair[] {new Pair<>(1,1), new Pair<>(5,4), new Pair<>(3,2)};}},
    E {@Override public Pair<Integer, Integer>[] getChangeFactors() {return (Pair<Integer, Integer>[]) new Pair[] {new Pair<>(4,3), new Pair<>(5,4), new Pair<>(3,2)};}};
